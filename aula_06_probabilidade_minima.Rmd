...
```{r grafico-bernoulli, fig.cap=caption_bernoulli, fig.height=2.8, out.width="0.62\\linewidth"}
grafico_bernoulli
```
...
```{r grafico-binomial, fig.cap=caption_binomial, fig.height=2.8, out.width="0.68\\linewidth"}
grafico_binomial
```
...
```{r grafico-uniforme, fig.cap=caption_uniforme, fig.height=2.8, out.width="0.62\\linewidth"}
grafico_uniforme
```
...
```{r grafico-normal, fig.cap=caption_normal, fig.height=2.8, out.width="0.62\\linewidth"}
grafico_normal
```
